...
labyrinth = Movie(
    ...
    baby brother when her wish for him to be taken away is granted by the
    Goblin King.''',
...
leon = Movie(
    ...
    after her family is murdered. Léon and Mathilda form an unusual
    relationship, as she becomes
...
movies = [fifth_element, titanic, labyrinth, leon, goonies,
