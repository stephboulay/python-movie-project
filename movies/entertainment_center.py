...
labyrinth = Movie (
    "Labyrinth",
    '''A 16-year-old girl is given 13 hours to solve a labyrinth and rescue her
    baby brother when her wish for him to be taken away is granted by the Goblin King.''',
    "http://www.gstatic.com/tv/thumb/movieposters/9355/p9355_p_v8_ae.jpg",
    "https://youtu.be/XRcOZZDvMv4")

leon = Movie (
    "Leon: The Professional",
    '''Mathilda, a 12-year-old girl, is reluctantly taken in by Léon, a professional assassin,
    after her family is murdered. Léon and Mathilda form an unusual relationship, as she becomes
...
goonies = Movie (
    ...
    a group of misfits set out to find a pirates ancient valuable treasure.''',
...
harry_potter_prisoner = Movie (
    ...
    '''It's Harry's third year at Hogwarts; not only does he have a new Defense Against the Dark Arts teacher,
    but there is also trouble brewing. Convicted murderer Sirius Black has escaped the Wizards'
